...
public class GamePanel extends JPanel {
    ...
    private void drawTank(Graphics g) {
        ...
        g.fillRect(t.getX(t) - Tank.SIZE_X / 2, Tank.Y_POS - Tank.SIZE_Y / 2, Tank.SIZE_X, Tank.SIZE_Y);
    ...
    private Polygon createTankFront(Tank t) {
        ...
        if (t.isFacingRight(t)) {
            tankFront.addPoint(t.getX(t) + Tank.SIZE_X / 2, Tank.Y_POS + Tank.SIZE_Y / 2);
            tankFront.addPoint(t.getX(t) + Tank.SIZE_X, Tank.Y_POS);
            tankFront.addPoint(t.getX(t) + Tank.SIZE_X / 2, Tank.Y_POS - Tank.SIZE_Y / 2);
        }
        else {
            tankFront.addPoint(t.getX(t) - Tank.SIZE_X / 2, Tank.Y_POS + Tank.SIZE_Y / 2);
